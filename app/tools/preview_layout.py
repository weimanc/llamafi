...
def _export(params: dict, out_dir: pathlib.Path) -> pathlib.Path:
    ...
    path.write_text(
        ...
        f"#define TASKBAR_ICON_W     {TASKBAR_ICON_W:4d}   // icon glyph width (centred in slot) — ADR-051, was 24\n"
        f"#define TASKBAR_ICON_H     {TASKBAR_ICON_H:4d}   // icon glyph height — ADR-051, was 24\n"
        "\n"
