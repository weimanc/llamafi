...
static const CityEntry kCities[] = {
    ...
    // UTC+11
    { "Noumea",        "NC", -22.2667f,  166.4500f, "<+11>-11",                           "Pacific/Noumea"                 },
    // UTC+10
    { "Sydney",        "AU", -33.8667f,  151.2167f, "AEST-10AEDT,M10.1.0,M4.1.0/3",      "Australia/Sydney"               },
    { "Melbourne",     "AU", -37.8167f,  144.9667f, "AEST-10AEDT,M10.1.0,M4.1.0/3",      "Australia/Melbourne"            },
    { "Brisbane",      "AU", -27.4667f,  153.0333f, "AEST-10",                            "Australia/Brisbane"             },
    // UTC+9:30
    { "Adelaide",      "AU", -34.9333f,  138.6000f, "ACST-9:30ACDT,M10.1.0,M4.1.0/3",    "Australia/Adelaide"             },
    // UTC+9
    { "Tokyo",         "JP",  35.6544f,  139.7447f, "JST-9",                              "Asia/Tokyo"                     },
    { "Seoul",         "KR",  37.5500f,  126.9667f, "KST-9",                              "Asia/Seoul"                     },
    { "Osaka",         "JP",  34.6939f,  135.5022f, "JST-9",                              "Asia/Tokyo"                     },
    // UTC+8
    { "Shanghai",      "CN",  31.2333f,  121.4667f, "CST-8",                              "Asia/Shanghai"                  },
    { "Beijing",       "CN",  39.9167f,  116.3833f, "CST-8",                              "Asia/Shanghai"                  },
    { "Singapore",     "SG",   1.2833f,  103.8500f, "<+08>-8",                            "Asia/Singapore"                 },
    { "Hong Kong",     "HK",  22.2855f,  114.1577f, "HKT-8",                              "Asia/Hong_Kong"                 },
    ...
    { "Ho Chi Minh",   "VN",  10.8167f,  106.6333f, "<+07>-7",                            "Asia/Ho_Chi_Minh"               },
    { "Hanoi",         "VN",  21.0333f,  105.8500f, "<+07>-7",                            "Asia/Ho_Chi_Minh"               },
    // UTC+6:30
    ...
    // UTC+5:30
    { "Mumbai",        "IN",  19.0758f,   72.8775f, "IST-5:30",                           "Asia/Kolkata"                   },
    ...
    { "Tashkent",      "UZ",  41.2667f,   69.2167f, "<+05>-5",                            "Asia/Tashkent"                  },
    { "Almaty",        "KZ",  43.2500f,   76.9500f, "<+05>-5",                            "Asia/Almaty"                    },
    // UTC+4
    { "Dubai",         "AE",  25.3000f,   55.3000f, "<+04>-4",                            "Asia/Dubai"                     },
    { "Baku",          "AZ",  40.3667f,   49.8352f, "<+04>-4",                            "Asia/Baku"                      },
    // UTC+3:30
    ...
    { "Vienna",        "AT",  48.2083f,   16.3731f, "CET-1CEST,M3.5.0,M10.5.0/3",        "Europe/Vienna"                  },
    ...
    { "Dublin",        "IE",  53.3331f,   -6.2489f, "IST-1GMT0,M10.5.0,M3.5.0/1",        "Europe/Dublin"                  },
    { "Accra",         "GH",   5.5500f,   -0.2167f, "GMT0",                               "Africa/Accra"                   },
