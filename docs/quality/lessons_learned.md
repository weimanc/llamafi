...
**Status**: applied in-session (both fixed same session: Q4 wired in, Q6 rounding fixed and re-verified before either was recorded as closed) — flagged to human as BP candidate
