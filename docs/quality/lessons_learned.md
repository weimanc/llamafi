...
**Status**: fixed in-session (TASK-321, commit `d40c04f`); `settingsWidgets.h` doc-comment update proposed for whoever picks up TASK-327; flagged to human as BP candidate.
